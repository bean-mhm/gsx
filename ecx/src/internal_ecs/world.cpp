...
namespace ecx::ecs
{
        ...
        logger(logger)
    {
        ...
        ecx_log(this, log_level_t::info, "World created");
    }

    world_t::~world_t()
    {
        ecx_log(this, log_level_t::info, "World destroyed");
    }

    void world_t::log(log_level_t log_level, const std::string& message)
    {
        ecx_log(this, log_level, message);
    }

    void world_t::enqueue_event(const event_t& event)
    {
        ecx_log(this, log_level_t::verbose,
    ...
    {
        ecx_log(this, log_level_t::verbose, std::format(
    ...
    {
        ecx_log(this, log_level_t::verbose, "Removing all systems");
        misc::vec_clear(systems);
    }

    void world_t::run(const f32 max_update_rate, const f32 max_run_time)
    {
        ecx_log(this, log_level_t::info, std::format(
        ...
        ecx_log(this, log_level_t::info, "Starting the loop");
        ...
        ecx_log(this, log_level_t::info, "Stopped running");
    }
    ...
    {
        ecx_log(this, log_level_t::info, "Preparing system groups and workers");
