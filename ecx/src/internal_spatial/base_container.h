...
namespace ecx::spatial
{

    // Base class for a 2D container
    // Note: T must be copy constructible.
    // Note: T must have a public field of type ecx::math::vec2 named pos, representing the 2D
    // position.
    template<typename T>
    ...
    // Note: T must be copy constructible.
    // Note: T must have a public field of type ecx::math::vec3 named pos, representing the 3D
    // position.
    template<typename T>
